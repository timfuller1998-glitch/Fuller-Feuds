// This file ensures server/static directory is included in the bundle
...
// Try to read index.html to ensure the static directory is included
// This must happen at module load time, not runtime
try {
  if (fs.existsSync(indexPath)) {
    // Read the file to ensure inclusion in build
