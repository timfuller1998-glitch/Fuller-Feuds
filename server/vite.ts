...
export function serveStatic(app: Express) {
  ...
  // NOTE: Since includeFiles doesn't work reliably, we copy files to server/static during build
  const possiblePaths = [
    // Strategy 1: Copied to server/static during build (most reliable)
